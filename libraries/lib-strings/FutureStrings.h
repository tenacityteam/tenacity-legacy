...
the translation catalog template, locale/tenacity.pot, to stabilize long enough
...
XC("Update Tenacity", "update dialog"),
...
XC("Unable to connect to Tenacity update server.", "update dialog"),
XC("Update data was corrupted.", "update dialog"),
XC("Error downloading update.", "update dialog"),
XC("Can't open the Tenacity download link.", "update dialog"),
// i18n-hint Substitution of version number for %s.
XC("Tenacity %s is available!", "update dialog"),
