...
void TenacityLogger::Show(bool show) {
    ...
    Destroy_ptr<wxFrame> frame{safenew wxFrame(NULL, wxID_ANY, _("Audacity Log"))};
    ...
    frame->Bind(wxEVT_CLOSE_WINDOW,
                wxCloseEventHandler(TenacityLogger::OnCloseWindow),
                this);

    frame->Bind(wxEVT_COMMAND_MENU_SELECTED,
                &TenacityLogger::OnSave,
                this, LoggerID_Save);
    frame->Bind(wxEVT_COMMAND_MENU_SELECTED,
                &TenacityLogger::OnClear,
                this, LoggerID_Clear);
    frame->Bind(wxEVT_COMMAND_MENU_SELECTED,
                &TenacityLogger::OnClose,
                this, LoggerID_Close);
...
void TenacityLogger::OnCloseWindow(wxCloseEvent &WXUNUSED(e)) {
...
void TenacityLogger::OnClose(wxCommandEvent &WXUNUSED(e)) {
    wxCloseEvent dummy;
    OnCloseWindow(dummy);
}

void TenacityLogger::OnClear(wxCommandEvent &WXUNUSED(e)) {
    ClearLog();
}

void TenacityLogger::OnSave(wxCommandEvent &WXUNUSED(e)) {
...
void TenacityLogger::UpdatePrefs() {
    if (mFrame) {
